  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta 
          name="description" 
          content="VKBack, agence web à Lyon depuis 14 ans. Création sites internet WordPress, e-commerce WooCommerce, SEO local. Développement sur-mesure. +200 clients ⭐ Devis gratuit" 
        />
